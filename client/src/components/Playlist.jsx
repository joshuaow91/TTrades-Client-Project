...
const Playlist = () => {
  ...
  return (
    <div className=''>
       <h2 className='text-4xl font-bold tracking-wide text-white text-opacity-80 uppercase text-center bg-zinc-800 rounded-md rounded-b-none mb-2 p-2'>Featured Playlist</h2>
