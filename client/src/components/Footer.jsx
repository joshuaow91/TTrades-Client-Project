...
const Footer = () => {
    ...
    return (
        <div className="flex flex-col mt-4 m-2 text-white text-sm font-light gap-x-10 bg-zinc-900 bg-opacity-30 rounded-md p-2 max-w-5xl">
            <div className="flex flex-col sm:flex-row items-center sm:justify-between mb-3 bg-zinc-800 p-2 rounded">
              <p className="text-left text-sm">
                &copy; TTrades 2023. All Rights Reserved.
              </p>
              <p>Made by <a className=" hover:text-white underline" href="https://joshuaow.com">Joshua Ow</a></p>
            </div>
            <div className="text-xs text-left max-h-44 overflow-scroll p-2 sm:max-h-96">
